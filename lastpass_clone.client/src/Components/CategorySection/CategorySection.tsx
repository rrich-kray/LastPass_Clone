    ...
    return (
        <div className={styles.CategorySection}>
            <div className={styles.CategorySectionHeader}>
                ...
                {isCollapsed ? <RxTriangleDown onClick={() => setIsCollapsed(false)} style={{ marginLeft: "5px" }} size={25} /> : <RxTriangleLeft onClick={() => setIsCollapsed(true)} style={{ marginLeft: "5px" }} size={25} />}
            </div>
